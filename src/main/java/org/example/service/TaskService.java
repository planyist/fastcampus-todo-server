...
public class TaskService {
    ...
    public Task update(Long id, String title, String description, LocalDate dueDate) {
        var entity = this.getById(id);
        entity.setTitle(Strings.isEmpty(title) ? entity.getTitle() : title);
        entity.setDescription(Strings.isEmpty(description) ? entity.getDescription() : description);
        entity.setDueDate(Objects.isNull(dueDate) ? entity.getDueDate() : Date.valueOf(dueDate));
