...
public class TaskController {
     ...
     * @param id 할일 ID
     * @param taskStatus 수정할 할일 상태 정보
     * @return 수정된 할일 객체
     */
    @PutMapping("/{id}/status")
    public ResponseEntity<Task> updateTaskStatus(@PathVariable Long id, @RequestBody TaskStatusRequest taskStatus) {
        var result = this.taskService.updateStatus(id, taskStatus.getStatus());
        return ResponseEntity.ok(result);
    }
